...
export default function Navbar() {
    ...
    const navigation = [{name: 'Home', href: '#', current: router.pathname === "/"}, {
        name: 'Records',
        href: '/speedruns',
        current: router.pathname.startsWith("/speedruns")
                                                        ...
                                                        <Popover.Panel
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    {(session && session.user && session.user.notification) ? session.user.notification.map((item) => (
                                                                        <p
                                                                            key={item.id}
                                                                        ...
                                                                        className="-m-3 block rounded-md p-3 transition duration-150 ease-in-out hover:bg-gray-50"
                                                                    >
                                                                        <p className="text-base font-medium text-gray-900">No notification</p>
                                                                        <p className="mt-1 text-sm text-gray-500">Check back later for new Notifications</p>
                                                                    </p>}
                                                                </div>
                                                            </div>
                                                        </Popover.Panel>
