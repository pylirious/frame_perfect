...
function Profile() {
    ...
    if (!session || !session.user) {
        return <>
            ...
            <div className={"m-5 bg-gray-300 shadow px-4 mt-24 py-5 sm:rounded-lg sm:px-10 sm:m-10 flex flex-row justify-center"}>
                <div>
                    <button
                        type="button"
                        onClick={() => signIn()}
    ...
    return (<>
        ...
        <div className={"m-5 bg-gray-300 shadow px-4 mt-24 py-5 sm:rounded-lg sm:px-10 sm:m-20 flex flex-col"}>
            <div
